...
np.savez(
    ...
    T_values=T_VALUES,
    B_values=B_VALUES,
    mink_N_times=mink_N_times,
    mink_N_mems=mink_N_mems,
    cross_N_times=cross_N_times,
    cross_N_mems=cross_N_mems,
    map2cl_N_times=map2cl_N_times,
    map2cl_N_mems=map2cl_N_mems,
    peak_N_times=peak_N_times,
    peak_N_mems=peak_N_mems,
    mink_H_times=mink_H_times,
    mink_H_mems=mink_H_mems,
    map2cl_H_times=map2cl_H_times,
    map2cl_H_mems=map2cl_H_mems,
    mink_T_times=mink_T_times,
    mink_T_mems=mink_T_mems,
    cross_B_times=cross_B_times,
    cross_B_mems=cross_B_mems,
